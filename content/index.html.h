...
"<div class=\"app-header\">Smart Flow Hall</div>"
"<p class=\"subtitle\">Configuração de Wi-Fi</p>"
"<h1>Escolha uma rede Wi-Fi</h1>"
"<form action=\"/settings\" method=\"get\">"
"<input type=\"submit\" id=\"refresh\" value=\"⟲ Atualizar\" />"
"</form>"
"<form action=\"/settings\" method=\"post\">"
"<div class=\"nonetworks\" style=\"display: none;\">Nenhuma rede encontrada</div>"
...
"<li class=\"other\">Escolher outra rede</li>"
"</ul>"
...
"</div>"
"<div class=\"toggle-password\" style=\"display: none;\">"
"<input type=\"checkbox\" id=\"toggle_password\" />"
"<label for=\"toggle_password\"> Mostrar senha</label>"
"</div>"
"<button type=\"submit\" id=\"join\" disabled>"
"<span id=\"join_label\">Conectar</span>"
"<span class=\"spinner\" aria-hidden=\"true\"></span>"
"</button>"
"</form>"
"<p class=\"footer\"><small>© 2026 Smart Sensor Design</small></p>"
"</div>"
"<script>"
...
"const toggle_password_block = document.querySelector('.toggle-password');"
"const toggle_password = document.getElementById('toggle_password');"
"const join_button = document.getElementById('join');"
"const join_label = document.getElementById('join_label');"
"const settings_form = document.querySelector('form[action=\"/settings\"][method=\"post\"]');"
"function enable(el) {"
"el.disabled = false;"
"}"
"function disable(el) {"
...
"if (isLoading) {"
"join_button.classList.add('loading');"
"join_button.setAttribute('aria-busy', 'true');"
"if (join_label) join_label.textContent = 'Conectando…';"
"disable(join_button);"
"} else {"
"join_button.classList.remove('loading');"
"join_button.removeAttribute('aria-busy');"
"if (join_label) join_label.textContent = 'Conectar';"
"}"
"}"
"function resetPasswordVisibility() {"
"if (!toggle_password) return;"
"toggle_password.checked = false;"
